    ...
    return (
        <div className='p-6 space-y-6'>
            ...
            <div className='bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm'>
                <h2 className='text-2xl font-bold text-gray-900 dark:text-white mb-2'>Quiz Settings</h2>
                <p className='text-gray-600 dark:text-gray-300'>Configure your quiz preferences and restrictions</p>
            </div>
                ...
                <div className='space-y-4'>
                    ...
                    <label className='flex items-center gap-3'>
                        <input
                            ...
                            className='w-4 h-4 text-blue-600 rounded focus:ring-blue-500'
                        />
                        <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>Allow Students to Review Quiz</span>
                    </label>
                </div>
            </div>
            ...
            <div className='bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm'>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={4}
                        className='w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-700 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500'
            ...
            <div className='flex justify-end'>
                <button 
                    ...
                    className='flex items-center gap-2 bg-blue-600 dark:bg-blue-700 text-white px-6 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors'
                >
